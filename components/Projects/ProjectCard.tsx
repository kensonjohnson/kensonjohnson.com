...
export default function ProjectCard({ item }: ItemProps) {
  return (
    <div className="rounded-lg border border-slate-200 shadow-lg dark:shadow-none hover:border-slate-300 dark:border-slate-800 dark:hover:border-slate-700 dark:bg-gradient-to-t dark:from-slate-800 dark:to-slate-800/30 transition-color ease-in-out p-5">
            ...
            <div className="flex gap-2">
              {item.link && (
                ...
                >
                  <div className="text-xs inline-flex items-center font-medium bg-blue-100 text-blue-600 rounded-full text-center px-2 h-5 group">
                    {item.websiteLink ? "Source" : "Project"} &nbsp;
              ...
              {item.websiteLink && (
                <Link
                  ...
                  target={item.websiteLink.startsWith("/") ? "_self" : "_blank"}
                  referrerPolicy="no-referrer"
                >
                  <div className="text-xs inline-flex items-center font-medium bg-amber-100 text-amber-600 rounded-full text-center px-2 h-5 group">
                    Website &nbsp;
                    <div className="text-amber-500 flex justify-end">
                      <svg
                        className="fill-current -rotate-45 group-hover:rotate-0 transition-transform ease-out"
                        xmlns="http://www.w3.org/2000/svg"
                        width="14"
