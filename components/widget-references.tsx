...
import MattProfilePic from "@/public/images/matt_gilbride_profile_pic.jpeg";
import StephenProfilePic from "@/public/images/stephen_lauck_profile_pic.jpeg";
    ...
    <div className="rounded-lg border border-slate-200 p-5 dark:border-slate-800 dark:bg-gradient-to-t dark:from-slate-800 dark:to-slate-800/30">
      ...
      <ul className="space-y-3">
        ...
        <li>
          <a
            className="group flex items-center justify-between space-x-2"
            href="https://www.linkedin.com/in/stephenlauck/"
          >
            <div className="flex grow items-center space-x-3 truncate">
              <Image
                className="rounded-full"
                src={StephenProfilePic}
                width={32}
                height={32}
                alt="Stephen Lauck Profile Pic"
              />
              <div className="truncate">
                <div className="mb-1 truncate font-aspekta text-sm font-[650]">
                  Stephen Lauck
